        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              講師排程與
              <span className="text-primary-600 block">人員分配平台</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <FiUsers className="h-6 w-6 mr-3 text-primary-600" />
                講師陣容
              </h3>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <FiClock className="h-6 w-6 mr-3 text-primary-600" />
                時段安排
              </h3>
                ...
                {timeSlots.map((slot, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-lg font-semibold text-primary-600">{slot.time}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <div className="py-24 bg-primary-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link
              to="/student/login"
              className="bg-white text-primary-600 hover:bg-gray-50 px-8 py-3 rounded-md text-lg font-medium transition-colors duration-200 flex items-center justify-center"
            >
              <FiUser className="h-5 w-5 mr-2" />
              我是學員
            </Link>
            <Link
              to="/admin/login"
              className="bg-primary-700 text-white hover:bg-primary-800 px-8 py-3 rounded-md text-lg font-medium transition-colors duration-200 flex items-center justify-center"
            >
              <FiSettings className="h-5 w-5 mr-2" />
              我是管理員
            </Link>
