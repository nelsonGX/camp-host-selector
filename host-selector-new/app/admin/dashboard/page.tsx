...
import { adminAPI, allocationAPI, authAPI, handleAPIError, downloadFile } from '../../../lib/api';
        ...
        <div className="bg-white rounded-lg shadow mb-8">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link href="/admin/results" className="btn btn-primary w-full">
                <FiEye className="h-4 w-4 mr-2" />
                查看結果
              </Link>

              <Link href="/admin/config" className="btn btn-outline w-full">
